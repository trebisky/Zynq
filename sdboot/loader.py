...
# copied from: /u1/Projects/Zynq/Git_zynq/secret

# Tom Trebisky  1-18-2025
#
# This uses the "secret" uart bootloader in the Zynq bootrom
# You will need to set your board jumpers for boot mode 3.
